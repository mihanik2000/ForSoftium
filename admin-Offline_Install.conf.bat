...
:: Если файл был запущен сам по себе, то просто выводим сообщение и заканчиваем работу.

if NOT defined ScriptPath (
	echo ========================================
	echo.
	echo Это конфигурационный файл.
	echo Сам по себе он ничего не делает
	echo.
	echo Откройте файл при помощи Notepad++ или обычного "Блокнота"
	echo для того, чтобы выполнить необходимые настройки.
	echo.
	echo ========================================
...
:: Ниже идёт описание разных параметров запуска основного скрипта.
...
:: Параметр: InstallYandexBrowser
::      Определяет необходимость установки YandexBrowser
::       0 - НЕ устанавливать YandexBrowser
::       1 - устанавливать YandexBrowser
::
:: Обязательный параметр: да
:: Значение по умолчанию: 1

set BInstallYandexBrowser=1
