...
{
	return {
		"name":			"Выбирающий файла",
		"id":			"filechooser",
		"version":		"1.0",
		"description":	"Разрешить пользователю выбрать файл из их устройства, а также получить доступ к выбранному файлу.",
		"author":		"Scirra",
...
var property_list = [
	new cr.Property(ept_text,	"Accept",				"",			"Фильтр типа файла, например, .png или изображение/*"),
	new cr.Property(ept_combo,	"Select",				"Single",	"Используйте одну или несколько выбора файлов.", "Single|Multiple"),
