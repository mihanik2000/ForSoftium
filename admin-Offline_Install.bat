...
:: ****************************************************************************************
:: разрешаем выполнение неподписанных ps-скриптов
...
CALL "%ScriptPath%Scripts\InstallAutoHotkey.bat"
...
if %BInstallYandexBrowser%==1 (
	CALL "%ScriptPath%Scripts\InstallYandexBrowser.bat"
)
