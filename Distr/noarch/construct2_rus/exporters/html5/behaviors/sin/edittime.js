...
{
	return {
		"name":			"Синусоида",			// as appears in 'add behavior' dialog, can be changed as long as "id" stays the same
		"id":			"Sin",			// this is used to identify this behavior and is saved to the project; never change it
		"version":		"1.0",
		"description":	"Настройка положение объекта, размер, угол или другие свойства с массажным синусоидам.",
		"author":		"Scirra",
...
var property_list = [
	new cr.Property(ept_combo, 		"Active on start",		"Yes",		"Включить поведение в начале макета.", "No|Yes"),
	new cr.Property(ept_combo,		"Movement",				"Horizontal", "Выберите то, что свойство объекта для изменения.", "Horizontal|Vertical|Size|Width|Height|Angle|Opacity|Value only|Forwards/backwards"),
	new cr.Property(ept_combo,		"Wave",					"Sine",		"Выберите вид волновой функции, используемой для расчета движения.", "Sine|Triangle|Sawtooth|Reverse sawtooth|Square"),
	new cr.Property(ept_float,		"Period",				4,			"Время в секундах, в течение полного цикла."),
	new cr.Property(ept_float,		"Period random",		0,			"Добавьте случайное число секунд до периода, до этого значения."),
	new cr.Property(ept_float,		"Period offset",		0,			"Начальное время в секундах, в течение цикла."),
	new cr.Property(ept_float,		"Period offset random",	0,			"Добавьте случайное число секунд, чтобы в начальный момент времени, до этого значения."),
	new cr.Property(ept_float,		"Magnitude",			50,			"Максимальное изменение пикселей, градусов, процентов и т.д."),
	new cr.Property(ept_float,		"Magnitude random",		0,			"Добавьте случайное число к величине, до этого значения.")
	];
