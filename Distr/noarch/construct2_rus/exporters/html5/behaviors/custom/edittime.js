...
{
	return {
		"name":			"Пользовательские движение",
		"id":			"custom",
		"version":		"1.0",
		"description":	"Сделайте свое собственное движение, используя функции движения низкого уровня.",
		"author":		"Scirra",
...
var property_list = [
	new cr.Property(ept_combo, "Stepping mode", "None", "Перемещение с шагом во время стрельбы ступенчатых триггеров.", "None|Linear|Horizontal then vertical|Vertical then horizontal"),
	new cr.Property(ept_integer, "Pixels per step",	5, "При пошаговом включена, количество пикселей для перемещения каждого шага."),
