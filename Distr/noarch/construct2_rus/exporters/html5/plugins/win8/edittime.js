function GetPluginSettings()
{
	return {
		...
		"description":	"Доступ к Windows 8 специфические функции, такие как оснастки и роумингу хранения.",
		"author":		"Scirra.com",
...
var property_list = [
	new cr.Property(ept_combo,	"Test mode",		"Yes",	"Установите 'Да' для тестирования покупок. Будьте уверены, чтобы установить 'Нет' при публикации.", "No|Yes"),
	new cr.Property(ept_combo,	"'About' setting",	"Yes",	"Покажите 'Анкета' 'в меню Настройки шармом, который открывается about.html.", "No|Yes"),
	//new cr.Property(ept_combo,	"'Preferences' setting", "Нет",	"Показать опцию 'Настройки' в очаровании настроек, который запускает "Одно предпочтения" и должны быть обработаны проекта.", "Нет|Да"),
	new cr.Property(ept_combo,	"'Support' setting", "Yes",	"Показать опции 'Поддержка' в очаровании настроек, которая открывает support.html.", "No|Yes"),
	new cr.Property(ept_combo,	"'Privacy' setting", "Yes",	"Показать опции 'Приватность' в очаровании настроек, которая открывает privacy.html.", "No|Yes")
	];
