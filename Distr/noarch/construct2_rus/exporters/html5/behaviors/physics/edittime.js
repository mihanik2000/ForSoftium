...
{
	return {
		"name":			"Физика",			// as appears in 'add behavior' dialog, can be changed as long as "id" stays the same
		"id":			"Physics",			// this is used to identify this behavior and is saved to the project; never change it
		"version":		"1.0",
		"description":	"Имитация физики реалистичный объект, питание от Box2DWeb.",
		"author":		"Scirra",
...
AddNumberParam("Implulse Y", "The vertical impulse to apply.");
...
var property_list = [
	new cr.Property(ept_combo, 		"Immovable",		"No",						"Включить, чтобы сделать объект имел бесконечную массу. Идеально подходит для пейзажей.", "No|Yes"),
	new cr.Property(ept_combo,		"Collision mask",	"Use collision polygon",	"Как объект сталкивается при моделировании физики.", "Use collision polygon|Bounding box|Circle"),
	new cr.Property(ept_combo,		"Prevent rotation",	"No",						"Предотвратить объект вращающийся при попадании.", "No|Yes"),
	new cr.Property(ept_float,		"Density",			1,							"Плотность объекта, если 'неподвижный' то'нет'."),
	new cr.Property(ept_float,		"Friction",			0.5,						"Коэффициент трения объекта, от 0 до 1."),
	new cr.Property(ept_float,		"Elasticity",		0.2,						"Объект эластичности (Реституция или 'bounciness') коэффициент, от 0 до 1."),
	new cr.Property(ept_float,		"Linear damping",	0.0,						"Коэффициент, чтобы замедлить движение в течение долгого времени, от 0 до 1."),
	new cr.Property(ept_float,		"Angular damping",	0.01,						"Коэффициент для замедления вращения в течение долгого времени, от 0 до 1."),
	new cr.Property(ept_combo, 		"Bullet",			"No",						"Включить расширенное обнаружение столкновений для быстро движущихся объектов.", "No|Yes"),
