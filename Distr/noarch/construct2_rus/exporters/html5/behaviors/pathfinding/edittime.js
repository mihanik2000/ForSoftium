...
{
	return {
		"name":			"Найти путь",			// as appears in 'add behavior' dialog, can be changed as long as "id" stays the same
		"id":			"Pathfinding",			// this is used to identify this behavior and is saved to the project; never change it
		"version":		"1.0",					// (float in x.y format) Behavior version - C2 shows compatibility warnings based on this
		"description":	"Найти пути вокруг препятствий, и, возможно, двигаться вдоль них.",
		"author":		"Scirra",
...
var property_list = [
	new cr.Property(ept_integer, 	"Cell size",		30,		"Размер ячеек для первопрохождения. Меньшие размеры будут использовать больше ресурсов процессора."),
	new cr.Property(ept_integer, 	"Cell border",		-1,		"Дополнительные сведения о размерах для обнаружения препятствий. Предотвращает пути очень близкие к препятствиям."),
	new cr.Property(ept_combo, 		"Obstacles",		"Solids",	"Используйте либо твердые вещества или пользовательские объекты в качестве препятствий.", "Solids|Custom"),
	new cr.Property(ept_float, 		"Max speed",		200,	"Для движения, максимальная скорость в пикселях в секунду."),
	new cr.Property(ept_float, 		"Acceleration",		1000,	"Для движения, ускорение в пикселях в секунду за секунду."),
	new cr.Property(ept_float, 		"Deceleration",		2000,	"Для движения, замедление в пикселях в секунду за секунду."),
	new cr.Property(ept_float, 		"Rotate speed",		135,	"Для движения, максимальная скорость поворота в градусах в секунду."),
	new cr.Property(ept_combo, 		"Rotate object",	"Да",	"Для движения, следует ли изменить угол объекта.", "Нет|Да"),
	new cr.Property(ept_combo, 		"Diagonals",	"Enabled",	"Независимо от того пути, разрешается использовать диагональные направления.", "Disabled|Enabled"),
	new cr.Property(ept_combo, "Initial state", "Enabled", "Независимо от того, чтобы изначально включить поведение или отключить.", "Disabled|Enabled")
	];
